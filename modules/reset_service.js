...
const services = {
        ...
        crypto.randomBytes(32 ,async(err,buffer)=>{
            ...
            if(userEmail){
               ...
               let mailOptions ={
                   ...
                   html : `
                   <p>click the <a href="https://happy-url-08.netlify.app/reset/${emailToken}">link</a> to reset your password</p>
    ...
    async createUrl(req , res){
        ...
        if(searchUrl){
            ...
            res.send(`https://happy-url-08.netlify.app/${searchUrl.shortUrl}`)
        }else{
            ...
            res.send(`https://happy-url-08.netlify.app/${shortUrl}`)
        }   
    },
